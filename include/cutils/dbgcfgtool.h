...
/* For User Space */
#define ERROR_CMD -1  //For JNI
static const char *dbgcfgtool_name = "/dev/dbgcfgtool";

#define GROUP_SIZE 32
#define DEBUG_UART_GROUP 0
#define DEBUG_MODEM_GROUP 3

#define CLEAN_BOOT_FILE_PATH "/data/clean_boot_finish"
 ...
 *
 * This enumeration needs to synchronize with /android/kernel/arch/arm/mach-msm/include/mach/dbgcfgtool.h
 *--------------------------------------------------------------------------*/
enum
{
